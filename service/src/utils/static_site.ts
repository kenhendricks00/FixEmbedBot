...
<body>
    ...
    <section id="premium" class="how-it-works-section" style="background: var(--bg-primary);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="glass-card">
                <div id="bot-usage" class="docs-section">
                    ...
                    <p style="color: var(--text-secondary);">When FixEmbed is added to a server, it automatically detects supported social media links and converts them to rich embeds. No commands needed! 💎 <strong>Premium servers</strong> also support links from other bots and webhooks automatically.</p>
                    ...
                    <p style="color: var(--text-secondary);">Configure which platforms are enabled/disabled, per-channel settings, and more. 💎 <strong>Premium servers</strong> can also set custom embed colors here.</p>
                </div>
